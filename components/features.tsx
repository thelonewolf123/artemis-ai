...
const features = [
  ...
  },
  {
    icon: FileText,
    title: "Smart Notes",
    description: "Custom instructions guide how Artemis responds. Your assistant evolves with your preferences.",
  },
  {
    icon: Brain,
    title: "RAG & Memory",
    description: "Upload documents and ask questions. Smart memory stores only what matters for your future.",
  },
  {
    icon: Phone,
    title: "Voice Support",
    description: "Send voice messages and get voice responses. Perfect for on-the-go conversations.",
  },
  {
    icon: Clock,
    title: "Daily Summary",
    description: "Get a comprehensive briefing every morning at 6am with tasks, emails*, and calendar events*.",
  },
  {
    icon: Zap,
    title: "Reminders",
    description: "Set intelligent reminders that keep you on track. Never miss important moments.",
  },
]
